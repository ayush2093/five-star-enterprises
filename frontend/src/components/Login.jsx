...
const AuthHeroSection = React.memo(() => (
  <div className="hidden lg:block bg-gray-50 border border-gray-200 rounded-2xl shadow-sm p-8 text-left">
    <div className="mb-8">
      <h1 className="text-4xl font-black text-gray-900 mb-2 uppercase tracking-wider">
        FIVE STAR
      </h1>
      <p className="text-lg text-gray-600 mb-6">
        Rent premium vehicles and customize your journeys.
      </p>
    </div>

    <div className="space-y-6">
      <FeatureItem emoji="🚗" title="Bespoke Fleet Studio" desc="Select and customize paint, trim, and amenities." />
      <FeatureItem emoji="🎨" title="Luxury Customizations" desc="Color layouts, chauffeur options, and travel extras." />
      <FeatureItem emoji="⚡" title="Real-Time Estimation" desc="Calculate routes and fare specifications instantly." />

      <div className="bg-[#e2383a]/10 border border-[#e2383a]/20 rounded-xl p-4 mt-8">
        <div className="flex items-center text-[#e2383a]">
          <CheckIcon />
          <span className="text-sm font-semibold">No credit card required to customize plans • Start now</span>
        </div>
      </div>
    </div>
  </div>
...
const AuthHeader = React.memo(({ activeTab }) => (
  <div className="text-center mb-8">
    ...
    <p className="text-gray-600">
      {activeTab === 'login' 
        ? 'Sign in to manage your premium trips' 
        : 'Join Five Star Enterprises and save your designs'
      }
    </p>
  </div>
));
