...
// Configure Google OAuth Strategy for Passport (only if credentials are provided)
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  ...
  console.log('⚠️ Google OAuth credentials not found in env. Google login is disabled.');
}
